...
Public Class CrystalReportSolvenciasProfesores
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrystalReportSolvenciasProfesores.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IES.CrystalReportSolvenciasProfesores.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_dpi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystalReportSolvenciasProfesores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportSolvenciasProfesores = New CrystalReportSolvenciasProfesores()
        rpt.Site = Me.Site
        Return rpt
    End Function
