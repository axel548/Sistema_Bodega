...
Public Class CrystalReportSolvenciasEstudiantes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrystalReportSolvenciasEstudiantes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IES.CrystalReportSolvenciasEstudiantes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_carne() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystalReportSolvenciasEstudiantes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportSolvenciasEstudiantes = New CrystalReportSolvenciasEstudiantes()
        rpt.Site = Me.Site
        Return rpt
    End Function
